...
//        int textviewLength = DeviceUtils.getDisplayWidth(getContext()) / 3;
//        int textLength = (int) tab.getPaint().measureText(tab.getText().toString());
//        tab.setCompoundDrawablePadding(textLength / 2 - textviewLength / 2 + 5);
        ...
        // TextView.getLayout().getLineWidth(tab.getText().toString()); //文字长度
        // TextView.getPaint().measureText(String text); //文字长度
