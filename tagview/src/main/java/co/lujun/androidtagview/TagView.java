...
public class TagView extends View {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int height = mVerticalPadding * 2 + (int) fontH + 10;
        int width = mHorizontalPadding * 2 + (int) fontW + (isEnableCross() ? height : 0) + 20;
...
//                    getHeight() / 2 + fontH / 2 - bdDistance, mPaint);
    ...
    public void setChosen(boolean flag) {
        if (flag) {
            this.mTextColor = ContextCompat.getColor(context, R.color.tagview_white);
            this.mBackgroundColor = ContextCompat.getColor(context, R.color.tagview_green);
        } else {
            this.mTextColor = ContextCompat.getColor(context, R.color.tagview_gray);
            this.mBackgroundColor = ContextCompat.getColor(context, R.color.tagview_white);
        }
        postInvalidate();
        requestLayout();
    }
